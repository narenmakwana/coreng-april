...
import {SampleDialogComponent} from 'app/examples/dialog/sample-dialog/sample-dialog.component';
import {SampleMenuDialogComponent} from 'app/examples/dialog/sample-menu-dialog/sample-menu-dialog.component';
import {CompletedDialogComponent} from 'app/examples/wizard/completed-dialog/completed-dialog.component';
...
@NgModule({
  ...
  entryComponents : [SampleDialogComponent, SampleMenuDialogComponent, CompletedDialogComponent],
  declarations : [DashboardComponent, BadgesComponent, ButtonsComponent, BreadcrumbsComponent, CardsComponent,
    ...
    ExampleComponent, DialogComponent, NotificationsComponent, WizardComponent, SampleDialogComponent, SampleMenuDialogComponent, CompletedDialogComponent],
})
